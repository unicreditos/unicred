  ...
  return (
    <div className="border-b border-white/10 bg-brand-navy-800 text-white">
      <div className="mx-auto flex w-full max-w-7xl items-center gap-4 overflow-x-auto px-4 py-1.5 sm:px-6">
        ...
        <p className="hidden shrink-0 text-[11px] font-medium text-white/70 lg:block">
...
export async function PublicBcraBoard({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-border/60 bg-card">
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-border/60 bg-muted/40 px-5 py-4 sm:px-6">
        <div>
          <p className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.14em] text-brand-primary">
            <Landmark className="h-3.5 w-3.5" />
            Dato oficial BCRA
          </p>
          <h2 className="mt-1 text-lg font-bold tracking-tight text-brand-navy sm:text-xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-t border-border/60 bg-muted/30 px-5 py-3 text-[11px] leading-relaxed text-muted-foreground sm:px-6">
        <p>
          Fuente:{' '}
