        ...
        <div className="lg:col-span-3">
          <PageSection eyebrow="Calculadora TNA · TEA · CFT" title="Simulá en 3 pasos">
            ...
            <div className="mt-6 flex flex-wrap gap-2 text-xs text-muted-foreground">
              <span className="rounded-full bg-muted px-3 py-1">Sin compromiso</span>
              <span className="rounded-full bg-muted px-3 py-1">Costos transparentes</span>
              <span className="rounded-full bg-muted px-3 py-1">Resultado al instante</span>
            </div>
          </PageSection>
        </div>
        <aside className="space-y-6 lg:col-span-2">
          <PageSection eyebrow="Por qué usar el simulador" title="Tomá decisiones informadas">
            <ul className="space-y-3 text-sm leading-relaxed text-brand-navy-700">
              {[
                ...
                <li key={x} className="flex items-start gap-2">
                  <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-brand-primary" /> {x}
                </li>
              ))}
            </ul>
          </PageSection>
          ...
          <PageSection eyebrow="Glosario" title="Qué significan las tasas">
            <dl className="space-y-3 text-sm">
              <div><dt className="font-semibold text-brand-navy">TNA · Tasa Nominal Anual</dt><dd className="text-muted-foreground">TEM × 12. Interés anual sin capitalizar.</dd></div>
              <div><dt className="font-semibold text-brand-navy">TEA · Tasa Efectiva Anual</dt><dd className="text-muted-foreground">(1 + TEM)^12 − 1. Exigida por Ley 24.240 art. 36 inc. d.</dd></div>
              <div><dt className="font-semibold text-brand-navy">CFT est. (IVA sobre intereses)</dt><dd className="text-muted-foreground">TEA × 1,21. Sin seguros ni gastos. No es el CFT de flujos de un sujeto BCRA. Este mutuo se informa por Ley 24.240, no por la Ley de tarjetas 25.065.</dd></div>
            </dl>
          </PageSection>
          ...
          <PageSection eyebrow="Listo para aplicar" title="Siguiente paso">
            <div className="rounded-2xl border border-border/60 bg-muted/40 p-5">
              <div className="flex items-start gap-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-brand-primary/10 text-brand-primary"><FileText className="h-5 w-5" /></div>
                <div>
                  <h3 className="text-sm font-semibold text-brand-navy">Siguiente paso: evaluación</h3>
            ...
            <div className="mt-4 flex items-center gap-2 rounded-xl border border-border/60 bg-card p-3 text-xs text-brand-navy-700">
              <ShieldCheck className="h-4 w-4 shrink-0 text-brand-primary" /> Datos cifrados. Ley 25.326. No hay WhatsApp ni 0800 como canal de cobro.
            </div>
          </PageSection>
        </aside>
      </div>
