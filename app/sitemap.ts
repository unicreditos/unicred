...
const routes: Route[] = [
  ...
  { path: '/comprar-en-cuotas', changeFrequency: 'monthly', priority: 0.3 },
  { path: '/pagos-servicios', changeFrequency: 'monthly', priority: 0.3 },
  { path: '/red-comercios', changeFrequency: 'monthly', priority: 0.3 },
  { path: '/comercios', changeFrequency: 'monthly', priority: 0.3 },
